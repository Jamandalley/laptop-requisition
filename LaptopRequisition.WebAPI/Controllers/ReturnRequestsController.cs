...
// using LaptopRequisition.Application.Extensions; // NEW: Added for ClaimsPrincipalExtensions
//
...
//         }
//
//         // Removed the local GetCurrentEmployeeId helper, now using extension method
...
//             try
//             {
//                 var employeeId = _httpContextAccessor.HttpContext?.User.GetEmployeeId(); // FIX: Use extension method
...
//                 if (returnRequest.EmployeeId != _httpContextAccessor.HttpContext?.User.GetEmployeeId()) // FIX: Use extension method
//                 {
